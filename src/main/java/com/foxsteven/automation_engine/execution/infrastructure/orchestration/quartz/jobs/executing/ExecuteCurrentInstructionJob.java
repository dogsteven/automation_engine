...
@Component
public class ExecuteCurrentInstructionJob implements Job {
    private final ExecutionCommandHandler executionCommandHandler;

    public ExecuteCurrentInstructionJob(ExecutionCommandHandler executionCommandHandler) {
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        executionCommandHandler.executeCurrentInstruction(instanceId);
    }
}
